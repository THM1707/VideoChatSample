...
import com.thm.videosample.utils.QBRTCSessionUtils;

import java.util.List;

public class OpponentsFromCallAdapter
    extends RecyclerView.Adapter<OpponentsFromCallAdapter.ViewHolder> {
    ...
    public OpponentsFromCallAdapter(Context context, QBRTCSession session, List<QBUser> users,
    ...
    public int getItemCount() {
        return opponents == null ? 0 : opponents.size();
    }
