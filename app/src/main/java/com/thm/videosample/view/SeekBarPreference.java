package com.thm.videosample.view;
...
public class SeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private void initFields(Context context, AttributeSet attrs) {
        int maxValueResourceId =
            attrs.getAttributeResourceValue(ANDROID_NS, "max", R.integer.pref_default_int_value);
        maxSeekBarValue = context.getResources().getInteger(maxValueResourceId);
        int minValueResourceId =
            attrs.getAttributeResourceValue(SEEKBAR_NS, "min", R.integer.pref_default_int_value);
        minSeekBarValue = context.getResources().getInteger(minValueResourceId);
        int stepSizeValueResourceId = attrs
            .getAttributeResourceValue(SEEKBAR_NS, "stepSize", R.integer.pref_default_int_value);
