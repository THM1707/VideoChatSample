...
import com.thm.videosample.adapter.OpponentsFromCallAdapter;
...
// TODO: 17/04/2018 how to set local view size
public class VideoConversationFragment extends BaseConversationFragment
    implements Serializable, QBRTCClientVideoTracksCallbacks<QBRTCSession>,
    ...
    protected void configureOutgoingScreen() {
        outgoingOpponentsRelativeLayout
            .setBackgroundColor(ContextCompat.getColor(getActivity(), R.color.grey_transparent_50));
    ...
    protected void configureToolbar() {
        ...
        toolbar.setBackgroundColor(
            ContextCompat.getColor(getActivity(), R.color.black_transparent_50));
    ...
    protected void initFields() {
        ...
        timerChronometer = getActivity().findViewById(R.id.timer_chronometer_action_bar);
    ...
    protected void initViews(View view) {
        ...
        if (!isPeerToPeerCall) {
            ...
            recyclerView.addItemDecoration(
                new DividerItemDecoration(getActivity(), R.dimen.grid_item_divider));
...
//          for correct removing item in adapter
    ...
    private void setGrid(int columnsCount) {
        ...
        opponentsAdapter =
            new OpponentsFromCallAdapter(getActivity(), currentSession, opponents, cellSizeWidth,
                ...
                if (currentSession.getPeerChannel(entry.getKey()).getState() !=
                    ...
                    mainHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            onRemoteVideoTrackReceive(currentSession, entry.getValue(),
                                entry.getKey());
                        }
    ...
    public void onStop() {
        ...
        if (connectionEstablished) {
            ...
            Log.d(TAG, "We are not in dialing process yet!");
        }
    }
    ...
    private void fillVideoView(int userId, QBRTCSurfaceView videoView, QBRTCVideoTrack videoTrack,
        ...
        // remove render for current video track and replace by new QBRTCSurfaceView render
        // map video with userId if userId != 0 -> only map remote video track with id
        // userId = 0 -> local track
        videoTrack.removeRenderer(videoTrack.getRenderer());
    ...
    public void onConnectionClosedForUser(QBRTCSession qbrtcSession, Integer userId) {
        // TODO: 17/04/2018 check what happen when remove video track map
...
//                startScreenSharing();
    ...
    private void switchCamera(final MenuItem item) {
        ...
        conversationFragmentCallbackListener
            .onSwitchCamera(new CameraVideoCapturer.CameraSwitchHandler() {
                @Override
                ...
                public void onCameraSwitchError(String s) {
                    ...
                    Toast.makeText(getActivity(), getString(R.string.camera_swicth_failed) + s,
    ...
    private void toggleCameraInternal() {
        ...
        updateVideoView(isLocalVideoFullScreen ? remoteFullScreenVideoView : localVideoView,
            isCurrentCameraFront);
        toggleCamera(true);
    }
