...
import com.thm.videosample.activity.CallActivity;
import com.thm.videosample.db.QbUsersDbManager;
import com.thm.videosample.utils.CollectionsUtils;
...
public abstract class BaseConversationFragment extends BaseToolBarFragment
    implements CallActivity.CurrentCallStateCallback {
    ...
    public static BaseConversationFragment newInstance(
        BaseConversationFragment baseConversationFragment, boolean isIncomingCall) {
