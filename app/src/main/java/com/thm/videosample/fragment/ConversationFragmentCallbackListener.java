...
public interface ConversationFragmentCallbackListener {
    ...
    void addCurrentCallStateCallback(
        CallActivity.CurrentCallStateCallback currentCallStateCallback);
    void removeCurrentCallStateCallback(
        CallActivity.CurrentCallStateCallback currentCallStateCallback);
    void addOnChangeAudioDeviceCallback(CallActivity.OnChangeAudioDevice onChangeDynamicCallback);
    void removeOnChangeAudioDeviceCallback(
        CallActivity.OnChangeAudioDevice onChangeDynamicCallback);
